...
public class SideLetterBars extends View {
    ...
    public SideLetterBars(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SideLetterBars(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SideLetterBars(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < b.length; i++) {
            ...
            paint.setColor(getResources().getColor(R.color.slow_black));
