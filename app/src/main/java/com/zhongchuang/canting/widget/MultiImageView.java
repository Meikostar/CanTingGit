...
public class MultiImageView extends LinearLayout {
    ...
    // 图片的Url列表
    private List<GoodsImageBean> imagesList;

    private String mainUrl;//主图URL
    ...
    public void setList(List<GoodsImageBean> lists) throws IllegalArgumentException {
        if (lists == null) {
    ...
    private ImageView createImageView(int position, final boolean isMultiImage) {
        GoodsImageBean photoInfo = imagesList.get(position);
        ...
        String show_url = photoInfo.url_;


        imageView.setId(show_url.hashCode());

        imageView.setOnClickListener(new ImageOnClickListener(position));

        //imageView.setBackgroundColor(getResources().getColor(R.color.im_font_color_text_hint));

        //imageView.setImageResource(R.drawable.common_bg_goods_default);moren

        Glide.with(getContext()).load(StringUtil.changeUrl(show_url)).asBitmap().placeholder(R.drawable.moren).into(imageView);
