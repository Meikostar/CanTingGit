...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mDividerView.setBackgroundColor(context.getResources().getColor(R.color.bg_239));
...
//        mLeftText.setBackground(context.getResources().getDrawable(R.drawable.list_bg_selector));
//        mLeftText.setBackgroundResource(R.drawable.list_bg_selector);
...
//            text.setBackground(getContext().getResources().getDrawable(R.drawable.list_bg_selector));
//            text.setBackgroundResource(R.drawable.list_bg_selector);
            view = text;
        }
