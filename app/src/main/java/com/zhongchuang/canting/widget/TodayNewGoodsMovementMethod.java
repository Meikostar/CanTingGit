...
/***
 * 功能描述:TodayNewGoodsMovementMethod
 * 作者:xiongning
 * 时间:2016/12/21
 * 版本:v1.0
 ***/

public class TodayNewGoodsMovementMethod extends BaseMovementMethod {

    public final String TAG = TodayNewGoodsMovementMethod.class.getSimpleName();
   ...
   // private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.default_clickable_color;
    ...
    public TodayNewGoodsMovementMethod(){

        this.textViewBgColor = CanTingAppLication.getInstance().getResources().getColor(DEFAULT_COLOR_ID);

      //  this.clickableSpanBgClor = MaKarApplication.mYunShlApplication.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
     ...
     */
    public TodayNewGoodsMovementMethod(int clickableSpanBgClor){
     ...
     */
    public TodayNewGoodsMovementMethod(int clickableSpanBgClor, int textViewBgColor){
