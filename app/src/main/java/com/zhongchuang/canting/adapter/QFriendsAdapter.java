...
import com.zhongchuang.canting.adapter.viewholder.TodayViewHolder;
 ...
 * 版本:v1.0
 ***/
public class QFriendsAdapter extends BaseAdapter {
   ...
   private List<QfriendBean> datas;
    @Override
    public int getCount() {
        int count = 0;
    ...
    public void setDatas( List<QfriendBean> datas){
        this.datas=datas;
   ...
   private ImageViewHolder viewHolder;
    ...
    public View getView( final int position, View convertView, ViewGroup parent) {
        if (view == null) {
            view = View.inflate(context, R.layout.fragment_qfriend, null);
...
//                        context.startActivity(intent);
    ...
    public QFriendsAdapter(Context context) {
