...
public class RecordAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.tv_in4 =view.findViewById(R.id.tv_in4);
        ...
        if(!TextUtils.isEmpty(integralist.changeType)){
            if(integralist.changeType.equals("1")){
                holder.tv_in1.setText(R.string.jfhyb);
        ...
        if(TextUtil.isNotEmpty(integralist.integral_instruction)){
            holder.tv_in1.setText(integralist.integral_instruction);
        }


        if(integralist.create_time!=0){
            holder.tv_in2.setText(TimeUtil.formatTtimeName(integralist.create_time));
        }
        if(TextUtil.isNotEmpty(integralist.integralType)){
        ...
        if(TextUtil.isNotEmpty(integralist.integral_state)){
            holder.tv_in3.setText(integralist.integral_state);
        }
