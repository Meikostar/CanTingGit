 ...
 */
public class ShopCycleAdapter extends BaseRecycleViewAdapter {
    ...
    public ShopCycleAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = null;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shop_item, null);
...
//        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holders, final int position) {
        ...
        ShopViewHolder holder= (ShopViewHolder) holders;
