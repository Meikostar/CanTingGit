...
public class ZhiBoHotRecyAdapter extends RecyclerView.Adapter<ZhiBoHotRecyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holders, int position) {
        ...
        if (state == 1) {
            ...
            Glide.with(hotContext).load(StringUtil.changeUrl(dataBean.cover_image)).asBitmap().placeholder(R.drawable.moren).into(holder.hotPic);
            if (TextUtil.isNotEmpty(dataBean.video_name)) {
                holder.tv_desc.setText(dataBean.video_name);
            } else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            iv_man = itemView.findViewById(R.id.iv_man);
