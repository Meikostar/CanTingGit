...
import com.zhongchuang.canting.easeui.ui.EaseBaseFragment;
...
//        clearSearch = (ImageButton) getView().findViewById(R.id.search_clear);
    ...
    protected void setUpView() {
        ...
        getContactList();
        //init list
        contactListLayout.init(contactList,status);
        ...
        if(listItemClickListener != null){
            ...
            listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                    EaseUser user = (EaseUser)listView.getItemAtPosition(position);
                     listItemClickListener.onLongListItemClicked(user);
                    return true;
...
//        });
                ...
                if (!entry.getKey().equals("item_new_friends")
                    ...
                    if(!blackList.contains(entry.getKey())){
                        ...
                        if(TextUtil.isNotEmpty(ids)){
                            String name = mp.get(user.getUsername());
                            if(type==1){
    ...
    public interface EaseContactListItemClickListener {
        ...
        void onLongListItemClicked(EaseUser user);
    }
