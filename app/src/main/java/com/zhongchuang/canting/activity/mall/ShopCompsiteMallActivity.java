...
public class ShopCompsiteMallActivity extends BaseAllActivity implements View.OnClickListener {
    ...
    private CompositelMallFragment fragment;
...
//        setEvents();
    ...
    private void exitApp() {
        ...
        if (TextUtils.isEmpty(olderToken)) {
            ...
            userInfoId = SpUtil.getString(ShopCompsiteMallActivity.this, "userInfoId", "");
            if (userInfoId != null) {
                SpUtil.remove(ShopCompsiteMallActivity.this, "userInfoId");//token值
            }
            //误操作  清理   不用处理
