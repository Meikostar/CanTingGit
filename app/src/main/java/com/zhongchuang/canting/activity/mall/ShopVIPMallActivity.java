...
import com.zhongchuang.canting.fragment.mall.IntegralVIPMallFragment;
...
public class ShopVIPMallActivity extends BaseAllActivity implements View.OnClickListener {
    ...
    private IntegralVIPMallFragment fragment1;
    ...
    public void initViews() {
        ...
        fragment1 = new IntegralVIPMallFragment();
...
//        setEvents();
        ...
        mSubscription = RxBus.getInstance().toObserverable(SubscriptionBean.RxBusSendBean.class).subscribe(new Action1<SubscriptionBean.RxBusSendBean>() {
            ...
            public void call(SubscriptionBean.RxBusSendBean bean) {
                ...
                if(bean.type==SubscriptionBean.LOGIN_FINISH){
                    exitApp();
                    Intent intent = new Intent(ShopVIPMallActivity.this, LoginActivity.class);
    ...
    private void exitApp() {
        ...
        if (TextUtils.isEmpty(olderToken)) {
            ...
            userInfoId = SpUtil.getString(ShopVIPMallActivity.this, "userInfoId", "");
            if (userInfoId != null) {
                SpUtil.remove(ShopVIPMallActivity.this, "userInfoId");//token值
            }
            //误操作  清理   不用处理
...
//                mTransaction.commit();
            ...
            case 3:
                ...
                pos = 3;
                if(!isLogin()){
                    startActivity(new Intent(ShopVIPMallActivity.this, LoginActivity.class));
                    return;
                }
