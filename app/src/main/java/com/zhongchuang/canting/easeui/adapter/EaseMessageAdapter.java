...
import com.zhongchuang.canting.easeui.widget.chatrow.EaseReBackRowText;
        ...
        private void refreshList() {
            ...
            for (EMMessage message : var) {
                ...
                if (message.getBody().getClass().equals(EMTextMessageBody.class)) {
                    ...
                    if (!contents.equals("*&@@&*") && !contents.contains("&!&&!&") && !contents.contains("@@@###!!")) {
                        mess.add(message);
                    }
                } else {
                    mess.add(message);
            ...
            case TXT:
                if (red) {
                    if (type.equals("1")) {
                        ...
                        chatRow = new EaseReBackRowText(context, chatType, message, position, this);
                    }
                } else {
                    if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
