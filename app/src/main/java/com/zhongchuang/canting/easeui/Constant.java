...
public class Constant extends EaseConstant {
	...
	public static final String POSITIONGING_INVITATION="sharelocation";
	public static final String UPDATE_INVITATION="update";
	public static final String SYSTEM_NAME="admin";
	public static final String ConversTopChat = "top_chat";
	public static final String FRIENDREQUEST = "friend_request";
	public static final int LOGIN_SUCCESS = 1;
	public static final int LOGIN_FAILUE = 2;
