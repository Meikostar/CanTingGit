...
public class EaseContactList extends RelativeLayout {
    ...
    protected RegularListView listView;
...
//    }
     ...
     * init view
     */
    public void init(List<EaseUser> contactList, int status){
    	this.contactList = contactList;
        adapter = new EaseContactAdapter(context, 0, new ArrayList<EaseUser>(contactList),status);
