...
//        intent.putExtra(AliyunConfig.KEY_FROM, "com.duanqu.qupai.action.recorder.setting");
    ...
    private void getStyleParam() {
        ...
        mLightDisableRes = a.getResourceId(4, R.mipmap.aliyun_svideo_icon_light_on);
...
//                    toSourceType();
            ...
            public void onFinish(String outputPath) {
                if(mIsToEditor)
                {
                    ...
                    Intent intent = new Intent(AliyunVideoRecorder.this,EditorActivity.class);
...
//        Class editor = null;
//        try {
//            editor = Class.forName("com.aliyun.alivcsolution.editor.editor.EditorActivity");
