...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        ...
        TypedArray array = paramContext.obtainStyledAttributes(paramAttributeSet, com.zhongchuang.canting.R.styleable.QuViewCircleProgressBar);
        mBackgroundWidth = array.getDimension(com.zhongchuang.canting.R.styleable.QuViewCircleProgressBar_backgroundWidth, mBackgroundWidth);
        mBackgroundHeight = array.getDimension(com.zhongchuang.canting.R.styleable.QuViewCircleProgressBar_backgroundHeight, mBackgroundHeight);
        mProgressWidth = array.getDimension(com.zhongchuang.canting.R.styleable.QuViewCircleProgressBar_progressWidth, mProgressWidth);
        mProgressThickness = array.getDimension(com.zhongchuang.canting.R.styleable.QuViewCircleProgressBar_progressThickness, mProgressThickness);
        mBackgroundColor = array.getColor(com.zhongchuang.canting.R.styleable.QuViewCircleProgressBar_backgroundColor, mBackgroundColor);
        mProgressColor = array.getColor(com.zhongchuang.canting.R.styleable.QuViewCircleProgressBar_progressColor, mProgressColor);
        progressThicknessColor = array.getColor(com.zhongchuang.canting.R.styleable.QuViewCircleProgressBar_progressThicknessColor, progressThicknessColor);
        array.recycle();
        instantiate();
    }
