...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        a = context.obtainStyledAttributes(attrs,
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip);

        indicatorColor = a.getColor(
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsIndicatorColor,
                indicatorColor);
        underlineColor = a.getColor(
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsUnderlineColor,
                underlineColor);
        dividerColor = a
                .getColor(com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsDividerColor,
                        dividerColor);
        indicatorHeight = a.getDimensionPixelSize(
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsIndicatorHeight,
                indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsUnderlineHeight,
                underlineHeight);
        dividerPadding = a.getDimensionPixelSize(
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsDividerPadding,
                dividerPadding);
        tabPadding = a.getDimensionPixelSize(
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsTabPaddingLeftRight,
                tabPadding);
        tabBackgroundResId = a.getResourceId(
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsTabBackground,
                tabBackgroundResId);
        shouldExpand = a
                .getBoolean(com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsShouldExpand,
                        shouldExpand);
        scrollOffset = a
                .getDimensionPixelSize(
                        com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsScrollOffset,
                        scrollOffset);
        textAllCaps = a.getBoolean(
                com.zhongchuang.canting.R.styleable.QuViewPagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
