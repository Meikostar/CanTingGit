package com.zhongchuang.canting.allive.vodplayerview.view.more;
...
public class ShowMoreViews extends LinearLayout implements View.OnClickListener,RadioGroup.OnCheckedChangeListener {
    ...
    public ShowMoreViews(AliyunPlayerSkinActivityMin context, AliyunShowMoreValue moreValue) {
        super(context);
