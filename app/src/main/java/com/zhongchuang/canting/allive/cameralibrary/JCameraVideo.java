package com.zhongchuang.canting.allive.cameralibrary;
...
import com.zhongchuang.canting.allive.cameralibrary.listener.CaptureListener;
...
import com.zhongchuang.canting.allive.cameralibrary.listener.TypeListener;
import com.zhongchuang.canting.allive.cameralibrary.state.CameraMachine;
import com.zhongchuang.canting.allive.cameralibrary.util.FileUtil;
import com.zhongchuang.canting.allive.cameralibrary.util.LogUtil;
import com.zhongchuang.canting.allive.cameralibrary.util.ScreenUtils;
import com.zhongchuang.canting.allive.cameralibrary.view.CameraView;
 ...
 * =====================================
 */
public class JCameraVideo extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, CameraView {
//    private static final String TAG = "JCameraView";
    ...
    public JCameraVideo(Context context) {
        this(context, null);
    }

    public JCameraVideo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JCameraVideo(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.camera_video, this);
...
//        });
    ...
    public void playVideos(Bitmap bitmap,String url){
        machine.playVideo(bitmap, url);
    }
...
//        CameraInterface.getInstance().doStartPreview(mVideoView.getHolder(), screenProp);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        new Thread() {
            @Override
            public void run() {
                CameraInterface.getInstance().doOpenCamera(JCameraVideo.this);
            }
        }.start();
    }
...
//                machine.start(mVideoView.getHolder(), screenProp);
    ...
    public void playVideo(Bitmap firstFrame, final String url) {
        videoUrl = url;
        JCameraVideo.this.firstFrame = firstFrame;
