...
package com.zhongchuang.canting.allive.editor.effects.paint;
...
public class ColorAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private PaintMenuView.PaintSelect mPaintSelect;
    ...
    public void setPaintSelect(PaintMenuView.PaintSelect paintSelect) {
