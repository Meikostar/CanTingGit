package com.zhongchuang.canting.allive.vodplayerview.widget;
...
import com.zhongchuang.canting.allive.vodplayerview.theme.IThemes;
import com.zhongchuang.canting.allive.vodplayerview.utils.ImageLoader;
import com.zhongchuang.canting.allive.vodplayerview.utils.NetWatchdog;
 ...
 */
public class AliyunVodPlayerViews extends RelativeLayout implements IThemes {

    private static final String TAG = AliyunVodPlayerViews.class.getSimpleName();
    ...
    public AliyunVodPlayerViews(Context context) {
        super(context);
        initVideoView();
    }

    public AliyunVodPlayerViews(Context context, AttributeSet attrs) {
        super(context, attrs);
        initVideoView();
    }

    public AliyunVodPlayerViews(Context context, AttributeSet attrs, int defStyleAttr) {
...
//先隐藏手势和控制栏，防止在没有prepare的时候做操作。
    ...
    public void setTheme(Theme theme) {
        ...
        for (int i = 0; i < childCounts; i++) {
            ...
            if (view instanceof IThemes) {
                ((IThemes) view).setTheme(theme);
            }
        }
    }
...
//        mControlView.updateDownloadBtn();
    ...
    private static class MyNetChangeListener implements NetWatchdog.NetChangeListener {
        ...
        private WeakReference<AliyunVodPlayerViews> viewWeakReference;

        public MyNetChangeListener(AliyunVodPlayerViews aliyunVodPlayerView) {
            viewWeakReference = new WeakReference<AliyunVodPlayerViews>(aliyunVodPlayerView);
        }

        @Override
        public void onWifiTo4G(){
            AliyunVodPlayerViews aliyunVodPlayerView = viewWeakReference.get();
    ...
    private  class InnerOrientationListener implements OrientationWatchDog.OnOrientationListener {
        ...
        private WeakReference<AliyunVodPlayerViews> playerViewWeakReference;

        public InnerOrientationListener(AliyunVodPlayerViews playerView) {
            playerViewWeakReference = new WeakReference<AliyunVodPlayerViews>(playerView);
        }

        @Override
        public void changedToLandScape(boolean fromPort) {
            AliyunVodPlayerViews playerView = playerViewWeakReference.get();
            if (playerView != null) {
    ...
    public ChangeScapeListener listeners;
    public void setChangeScapeListener(ChangeScapeListener listener){
   ...
   public   void changeQuality(String quality){
        ...
        mGestureView.setOnGestureListener(new GestureView.GestureListener() {
            ...
            public void onHorizontalDistance(float downX, float nowX) {
                ...
                if (mGestureDialogManager != null) {
                    mGestureDialogManager.showSeekDialog(AliyunVodPlayerViews.this, (int) position);
            ...
            public void onLeftVerticalDistance(float downY, float nowY) {
                ...
                if (mGestureDialogManager != null) {
                    mGestureDialogManager.showBrightnessDialog(AliyunVodPlayerViews.this);
            ...
            public void onRightVerticalDistance(float downY, float nowY) {
                ...
                if (mGestureDialogManager != null) {
                    mGestureDialogManager.showVolumeDialog(AliyunVodPlayerViews.this, volume);
        ...
        mAliyunVodPlayer.setOnErrorListener(new IAliyunVodPlayer.OnErrorListener() {
            ...
            public void onError(int errorCode, int errorEvent, String errorMsg) {
                if (errorCode == AliyunErrorCode.ALIVC_ERR_INVALID_INPUTFILE.getCode()) {
                    ...
                    int storagePermissionRet = ContextCompat.checkSelfPermission(AliyunVodPlayerViews.this.getContext().getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private static class ProgressUpdateTimer extends Handler {
        ...
        ProgressUpdateTimer(AliyunVodPlayerViews aliyunVodPlayerView) {
            viewWeakReference = new WeakReference<AliyunVodPlayerViews>(aliyunVodPlayerView);
        }
    ...
    private class MyNetConnectedListener implements NetWatchdog.NetConnectedListener {
        public MyNetConnectedListener( AliyunVodPlayerViews aliyunVodPlayerView) {}
