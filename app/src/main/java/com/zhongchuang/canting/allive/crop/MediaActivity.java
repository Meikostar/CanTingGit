...
package com.zhongchuang.canting.allive.crop;
...
import com.zhongchuang.canting.allive.crop.media.GalleryDirChooser;
import com.zhongchuang.canting.allive.crop.media.GalleryMediaChooser;
import com.zhongchuang.canting.allive.crop.media.MediaDir;
import com.zhongchuang.canting.allive.crop.media.MediaInfo;
import com.zhongchuang.canting.allive.crop.media.MediaStorage;
import com.zhongchuang.canting.allive.crop.media.ThumbnailGenerator;
...
public class MediaActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.zhongchuang.canting.R.layout.aliyun_svideo_activity_media);
        getData();
        init();
    }
    ...
    private void init(){
        ...
        galleryDirChooser = new GalleryDirChooser(this, findViewById(com.zhongchuang.canting.R.id.aliyun_topPanel), thumbnailGenerator, storage);
        ...
        storage.setOnMediaDirChangeListener(new MediaStorage.OnMediaDirChange() {
            ...
            public void onMediaDirChanged() {
                ...
                if (dir.id == -1) {
                    title.setText(getString(com.zhongchuang.canting.R.string.aliyun_gallery_all_media));
                } else {
