...
public class VideoRecordSmallView extends LinearLayout {
    ...
    public VideoRecordSmallView(Context context) {
        ...
        mRecording = view.findViewById(R.id.recording_linear);
        mOpera = view.findViewById(R.id.opera_linear);
        mBack = view.findViewById(R.id.back);
        mPrivacy = view.findViewById(R.id.privacy);
        mCamera = view.findViewById(R.id.camera);
        mMic = view.findViewById(R.id.mic);
        mMix = view.findViewById(R.id.mix);
