...
import com.zhongchuang.canting.allive.vodplayerview.view.more.ShowMoreViews;
 ...
 * 播放器和播放列表界面
 */
public class AliyunPlayerSkinActivityMin extends AppCompatActivity implements OtherContract.View, BaseContract.View {
    ...
    private HeartLayout heart_layout = null;
   ...
   private Handler handler =new Handler(new Handler.Callback() {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alivc_player_layout_skin_min);
    ...
    public void setHostData(BEAN data){
        ...
        String title="";
            ...
            title=(TextUtil.isNotEmpty(ben.room_image)?ben.room_image:"#")+","+
                    (TextUtil.isNotEmpty(ben.user_info_nickname)?ben.user_info_nickname:"#")+","+data.fans_num+","+ ben.type+","+(TextUtil.isNotEmpty(ben.live_address)?ben.live_address:"#");
...
//                shareBean.content_ = data.direct_see_name + getString(R.string.zzgszbklgkb);
    ...
    private void inittab() {
        ...
        iv_share = (ImageView) findViewById(R.id.iv_shares);
        ...
        tvChats.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentc = new Intent(AliyunPlayerSkinActivityMin.this, ChatActivity.class);
...
//                flbg.setClickable(false);
        ...
        iv_share.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ShareUtils.showMyShares(AliyunPlayerSkinActivityMin.this, getString(R.string.jiguang), "http://www.gwlaser.tech");
            }
        });
        ...
        switch (poistion) {
            ...
            case 2:
                ...
                if (view_stub_zb == null) {
                    ...
                    qFriendsAdapter = new QFriendsAdapter(AliyunPlayerSkinActivityMin.this);
                    liveAdapter = new VideoLiveAdapter(AliyunPlayerSkinActivityMin.this);
                    updateTabView();
                    intListener();
                } else {
            ...
            case 3:
                ...
                if (view_stub_hand == null) {
                    ...
                    handGitsAdapter = new HandGitsAdapter(AliyunPlayerSkinActivityMin.this);
        ...
        liveAdapter.setTakeListener(new VideoLiveAdapter.TakeawayListener() {
            ...
            public void listener(int poistion) {
                ...
                if(!dat.get(poistion).new_type.equals("0")){
                    ...
                    Intent intent = new Intent(AliyunPlayerSkinActivityMin.this, AliyunPlayerSkinActivity.class);
                    ...
                    if(dat.get(poistion).video_type==2){
                        ...
                        Intent intent = new Intent(AliyunPlayerSkinActivityMin.this, AliyunPlayerSkinActivityMin.class);
                        intent.putExtra("url",dat.get(poistion).video_url);
                        intent.putExtra("name",dat.get(poistion).video_name);
                        intent.putExtra("room_info_id",dat.get(poistion).room_info_id);
                        intent.putExtra("id",dat.get(poistion).user_info_id);
...
//        mAliyunVodPlayerView.setState(2);
...
//        mAliyunVodPlayerView.setVideoScalingMode(IAliyunVodPlayer.VideoScalingMode.VIDEO_SCALING_MODE_SCALE_TO_FIT_WITH_CROPPING);
        ...
        mAliyunVodPlayerView.setOnCareClickListener(new AliyunVodPlayerView.OnCareClickListener() {
            @Override
            public void onClick() {
                heart_layout.addHeart(randomColor());
                ChatFragments.sendMessage();
            }
        });
        mAliyunVodPlayerView.setChangeScapeListener(new AliyunVodPlayerView.ChangeScapeListener() {
            @Override
            public void change(boolean fromLand) {
                if (fromLand) {
                    //转为竖屏了。
                    //显示状态栏
                    //                if (!isStrangePhone()) {
...
//                    AliyunPlayerSkinActivityMin.this.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
...
//                            .getLayoutParams();
//                    aliVcVideoViewLayoutParams.height = (int) (ScreenUtils.getWidth(AliyunPlayerSkinActivityMin.this) * 9.0f / 16);
...
//                    //隐藏状态栏
//                    if (!isStrangePhone()) {
//                        AliyunPlayerSkinActivityMin.this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
...
//                    aliVcVideoViewLayoutParams.width = ViewGroup.LayoutParams.MATCH_PARENT;
        ...
        mAliyunVodPlayerView.setGiftMessageListener(new AliyunVodPlayerView.GiftMessageListener() {
            @Override
            public void click(int poistion,int type) {
                if(type==1){
                      mAliyunVodPlayerView.setChangeLand();
                      selectPosition(0);
                }
//
                if(poistion==1){
...
//            onDataLoaded(TYPE_PULL_REFRESH, false, datas);
    ...
    private static class MyPrepareListener implements IAliyunVodPlayer.OnPreparedListener {
        ...
        private WeakReference<AliyunPlayerSkinActivityMin> activityWeakReference;

        public MyPrepareListener(AliyunPlayerSkinActivityMin skinActivity) {
            activityWeakReference = new WeakReference<AliyunPlayerSkinActivityMin>(skinActivity);
        }

        @Override
        public void onPrepared() {
            AliyunPlayerSkinActivityMin activity = activityWeakReference.get();
            if (activity != null) {
                activity.onPrepared();
            }
        }
    ...
    private void onPrepared() {
        ...
        Toast.makeText(AliyunPlayerSkinActivityMin.this.getApplicationContext(), R.string.toast_prepare_success,
    ...
    private static class MyCompletionListener implements IAliyunVodPlayer.OnCompletionListener {
        ...
        public MyCompletionListener(AliyunPlayerSkinActivityMin skinActivity) {
            activityWeakReference = new WeakReference<AliyunPlayerSkinActivityMin>(skinActivity);
        }
    ...
    private void onCompletion() {
        ...
        Toast.makeText(AliyunPlayerSkinActivityMin.this.getApplicationContext(), R.string.toast_play_compleion,
                Toast.LENGTH_SHORT).show();
    ...
    private static class MyFrameInfoListener implements IAliyunVodPlayer.OnFirstFrameStartListener {
        ...
        public MyFrameInfoListener(AliyunPlayerSkinActivityMin skinActivity) {
            activityWeakReference = new WeakReference<AliyunPlayerSkinActivityMin>(skinActivity);
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_EXTERNAL_STORAGE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // Permission Denied
                Toast.makeText(AliyunPlayerSkinActivityMin.this, "没有sd卡读写权限, 无法下载", Toast.LENGTH_SHORT).show();
            }
            return;
        }
    ...
    private static class MyChangeQualityListener implements IAliyunVodPlayer.OnChangeQualityListener {
        ...
        public MyChangeQualityListener(AliyunPlayerSkinActivityMin skinActivity) {
            activityWeakReference = new WeakReference<AliyunPlayerSkinActivityMin>(skinActivity);
        }
    ...
    private void onChangeQualitySuccess(String finalQuality) {
        Toast.makeText(AliyunPlayerSkinActivityMin.this.getApplicationContext(),
    ...
    private static class MyStoppedListener implements IAliyunVodPlayer.OnStoppedListener {
        ...
        public MyStoppedListener(AliyunPlayerSkinActivityMin skinActivity) {
            activityWeakReference = new WeakReference<AliyunPlayerSkinActivityMin>(skinActivity);
        }
    ...
    private void onStopped() {
        Toast.makeText(AliyunPlayerSkinActivityMin.this.getApplicationContext(), R.string.log_play_stopped,
                Toast.LENGTH_SHORT).show();
    }
    ...
    private void updatePlayerViewMode() {
        ...
        if (mAliyunVodPlayerView != null) {
            ...
            if (orientation == Configuration.ORIENTATION_PORTRAIT) {
                ...
                //                    getSupportActionBar().show();
                //                }
               if(currentScreenMode==AliyunScreenMode.Full){
                   mAliyunVodPlayerView.setVideoScalingMode(IAliyunVodPlayer.VideoScalingMode.VIDEO_SCALING_MODE_SCALE_TO_FIT_WITH_CROPPING);
                   //设置view的布局，宽高
                   RelativeLayout.LayoutParams aliVcVideoViewLayoutParams = (RelativeLayout.LayoutParams) mAliyunVodPlayerView
                           .getLayoutParams();
...
//                                }
    ...
    private static class PlayerHandler extends Handler {
        ...
        private final WeakReference<AliyunPlayerSkinActivityMin> mActivty;

        public PlayerHandler(AliyunPlayerSkinActivityMin activity) {
            mActivty = new WeakReference<AliyunPlayerSkinActivityMin>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            AliyunPlayerSkinActivityMin activity = mActivty.get();
    ...
    private static class MyStsListener implements VidStsUtil.OnStsResultListener {
        ...
        private WeakReference<AliyunPlayerSkinActivityMin> weakctivity;

        public MyStsListener(AliyunPlayerSkinActivityMin act) {
            weakctivity = new WeakReference<AliyunPlayerSkinActivityMin>(act);
        }

        @Override
        public void onSuccess(String vid, String akid, String akSecret, String token) {
            AliyunPlayerSkinActivityMin activity = weakctivity.get();
            if (activity != null) {
    ...
    private  class MyOrientationChangeListener implements AliyunVodPlayerView.OnOrientationChangeListener {
        ...
        private final WeakReference<AliyunPlayerSkinActivityMin> weakReference;

        public MyOrientationChangeListener(AliyunPlayerSkinActivityMin activity) {
            weakReference = new WeakReference<>(activity);
        }

        @Override
        public void orientationChange(boolean from, AliyunScreenMode currentMode) {
            AliyunPlayerSkinActivityMin activity = weakReference.get();
    ...
    private class MyNetConnectedListener implements AliyunVodPlayerView.NetConnectedListener {
        WeakReference<AliyunPlayerSkinActivityMin> weakReference;

        public MyNetConnectedListener(AliyunPlayerSkinActivityMin activity) {
            weakReference = new WeakReference<>(activity);
        }
    ...
    private static class MyOnUrlTimeExpiredListener implements IAliyunVodPlayer.OnUrlTimeExpiredListener {
        ...
        public MyOnUrlTimeExpiredListener(AliyunPlayerSkinActivityMin activity) {
            weakReference = new WeakReference<AliyunPlayerSkinActivityMin>(activity);
        }
    ...
    private  class MyShowMoreClickLisener implements ControlLiveView.OnShowMoreClickListener {
        ...
        MyShowMoreClickLisener(AliyunPlayerSkinActivityMin activity) {
            weakReference = new WeakReference<>(activity);
        }
...
//            activity.showMore(activity);
    ...
    private void showMore(final AliyunPlayerSkinActivityMin activity) {
        ...
        ShowMoreViews showMoreView = new ShowMoreViews(activity, moreValue);
        showMoreDialog.setContentView(showMoreView);
        showMoreDialog.show();
        showMoreView.setOnDownloadButtonClickListener(new ShowMoreViews.OnDownloadButtonClickListener() {
            @Override
        ...
        showMoreView.setOnScreenCastButtonClickListener(new ShowMoreViews.OnScreenCastButtonClickListener() {
            @Override
            public void onScreenCastClick() {
                Toast.makeText(AliyunPlayerSkinActivityMin.this, "功能开发中, 敬请期待...", Toast.LENGTH_SHORT).show();
            }
        });

        showMoreView.setOnBarrageButtonClickListener(new ShowMoreViews.OnBarrageButtonClickListener() {
            @Override
        ...
        showMoreView.setOnSpeedCheckedChangedListener(new ShowMoreViews.OnSpeedCheckedChangedListener() {
            @Override
        ...
        // 亮度seek
        showMoreView.setOnLightSeekChangeListener(new ShowMoreViews.OnLightSeekChangeListener() {
            @Override
        ...
        showMoreView.setOnVoiceSeekChangeListener(new ShowMoreViews.OnVoiceSeekChangeListener() {
            @Override
            public void onStart(SeekBar seekBar) {
