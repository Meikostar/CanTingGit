...
import com.zhongchuang.canting.allive.quview.SquareFrameLayout;
...
//        return (int) Math.round(count);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.thumblayout = convertView.findViewById(R.id.video_tailor_frame);
            holder.thumbImage = convertView.findViewById(R.id.video_tailor_img_item);
