...
public final class BadgeUtil {
    ...
    /**
     * 设置MIUI的Badge
     *builder.setContentTitle("对了").setContentText("你的好友发来一条消息").setSmallIcon(R.drawable.logo).setAutoCancel(true);
     * @param context context
     * @param count   count
     */
    private static void setBadgeOfMIUI(Context context, int count, int iconResId) {
        ...
        builder.setContentTitle("对了").setContentText("你的好友发来一条消息").setSmallIcon(iconResId);
