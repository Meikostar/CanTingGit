...
public class DecimalUtil {
    ...
    public static String addWithScale(String v1, String v2,int scale) {
        ...
        return b.setScale(scale).toString();
    }
     ...
     * @return
     */
    public static String subtractWithScale(String v1, String v2,int scale) {
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
     ...
     * @return
     */
    public static String  withScale(String v1 , int scale) {
        BigDecimal b1 = new BigDecimal(v1);
        b1 = b1.setScale(scale);
        return b1.toString();
    }
