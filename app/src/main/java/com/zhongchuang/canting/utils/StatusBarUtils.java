...
public class StatusBarUtils {
     ...
     * @param color    状态栏颜色值setWindowStatusBarColor
     */
    public static void setWindowStatusBarColor(Activity activity, @ColorInt int color) {
    ...
    public static void setColor(Activity activity, @ColorInt int color, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (count > 0 && decorView.getChildAt(count - 1) instanceof View) {
                ...
                View statusView = createView(activity, color, statusBarAlpha);
    ...
    public static void setColorDiff(Activity activity, @ColorInt int color) {
        ...
        if (count > 0 && decorView.getChildAt(count - 1) instanceof View) {
            ...
            View statusView = createView(activity, color);
            decorView.addView(statusView);
        }
        setRootView(activity);
    }
    ...
    public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, @ColorInt int color,
        ...
        if (contentLayout.getChildCount() > 0 && contentLayout.getChildAt(0) instanceof View) {
            contentLayout.getChildAt(0).setBackgroundColor(calculateStatusColor(color, statusBarAlpha));
        } else {
            View View = createView(activity, color);
    ...
    private static void addTranslucentView(Activity activity, int statusBarAlpha) {
        ...
        if (contentView.getChildCount() > 1) {
            ...
            contentView.addView(createTranslucentView(activity, statusBarAlpha));
        }
    }
     ...
     * @return 状态栏矩形条
     */
    private static View createView(Activity activity, @ColorInt int color) {
        // 绘制一个和状态栏一样高的矩形
     ...
     * @return 状态栏矩形条
     */
    private static View createView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        View View = new View(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
     ...
     * @return 半透明 View
     */
    private static View createTranslucentView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        View View = new View(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
