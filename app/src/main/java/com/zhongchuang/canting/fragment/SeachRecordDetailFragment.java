...
public class SeachRecordDetailFragment extends BaseFragment implements BaseContract.View {
    ...
    public SeachRecordDetailFragment() {
    }

    public SeachRecordDetailFragment(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshListener = new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                  ...
                  if(TextUtil.isEmpty(tvDatefrom.getText().toString())||TextUtil.isEmpty(tvDateto.getText().toString())){
                      return;
                  }
                presenter.recordIntegralDetails(TYPE_PULL_REFRESH,currpage+"",type+"",0+"",TimeUtil.getStringToDate(tvDatefrom.getText().toString())+"",TimeUtil.getStringToDate(tvDateto.getText().toString())+"");
        ...
        if (haveNext) {
            mSuperRecyclerView.setupMoreListener(new OnMoreListener() {
                ...
                public void onMoreAsked(int overallItemsCount, int itemsBeforeMore, int maxLastVisiblePosition) {
                    currpage++;
                    mSuperRecyclerView.showMoreProgress();
                    presenter.recordIntegralDetails(TYPE_PULL_MORE,currpage+"",type+"",0+"",TimeUtil.getStringToDate(tvDatefrom.getText().toString())+"",TimeUtil.getStringToDate(tvDateto.getText().toString())+"");
