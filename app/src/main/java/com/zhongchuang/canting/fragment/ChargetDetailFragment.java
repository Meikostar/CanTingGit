...
public class ChargetDetailFragment extends BaseFragment implements BaseContract.View {
    ...
    public ChargetDetailFragment() {
    }

    public ChargetDetailFragment(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshListener = new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                presenter.integralDetails(TYPE_PULL_REFRESH, currpage + "", status + "", type + "", "", "",null);
        ...
        if (haveNext) {
            mSuperRecyclerView.setupMoreListener(new OnMoreListener() {
                ...
                public void onMoreAsked(int overallItemsCount, int itemsBeforeMore, int maxLastVisiblePosition) {
                    currpage++;
                    mSuperRecyclerView.showMoreProgress();
                    presenter.integralDetails(TYPE_PULL_MORE, currpage + "", status + "", type + "", "", "",null);
