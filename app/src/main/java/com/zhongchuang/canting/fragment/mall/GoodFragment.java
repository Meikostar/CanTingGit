...
public class GoodFragment extends BaseFragment implements BaseContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshListener = new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                presenter.getProductList(TYPE_PULL_REFRESH, 1 + "", cout + "", TextUtil.isEmpty(content) ? "" : content, "" + status, "" + type, "2");
            ...
            mSuperRecyclerView.setupMoreListener(new OnMoreListener() {
                ...
                public void onMoreAsked(int overallItemsCount, int itemsBeforeMore, int maxLastVisiblePosition) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if (haveNext)
                                presenter.getProductList(TYPE_PULL_MORE, currpage + "", cout + "", TextUtil.isEmpty(content) ? "" : content, "" + status, "" + type, "2");
                            mSuperRecyclerView.hideMoreProgress();
