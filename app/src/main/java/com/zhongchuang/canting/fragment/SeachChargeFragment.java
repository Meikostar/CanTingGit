...
public class SeachChargeFragment extends BaseFragment implements BaseContract.View {
    ...
    public SeachChargeFragment() {
    }

    public SeachChargeFragment(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshListener = new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                presenter.integralDetails(TYPE_PULL_REFRESH, currpage + "", status + "", 0 + "", "", "",null);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtil.isNotEmpty(tvDatefrom.getText().toString()) && TextUtil.isNotEmpty(tvDateto.getText().toString())) {
                    presenter.integralDetails(TYPE_PULL_REFRESH, currpage + "", status + "", 0 + "", TimeUtil.getStringToDate(tvDatefrom.getText().toString()) + "", TimeUtil.getStringToDate(tvDateto.getText().toString()) + "",null);
