...
public class UpdateVideoFragment extends Fragment implements   OtherContract.View {
    ...
    public UpdateVideoFragment(Context context) {
    ...
    private void initFragMents(int poistion) {
        ...
        for (int i = 0; i < firstData.size(); i++) {
            UpdateItemVideoFragment gameFragment = new UpdateItemVideoFragment(getActivity());
