...
public class GoodFragments extends BaseFragment  implements BaseContract.View {
    ...
    public GoodFragments(int type,String content) {
        this.type=type;
        this.content=content;
    }
    public GoodFragments() {
    }

    public GoodFragments(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshListener = new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                presenter.getProductBySecondName(TYPE_PULL_REFRESH,1+"",cout+"",TextUtil.isEmpty(content)?"":content,type+"");
            ...
            mSuperRecyclerView.setupMoreListener(new OnMoreListener() {
                ...
                public void onMoreAsked(int overallItemsCount, int itemsBeforeMore, int maxLastVisiblePosition) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if (haveNext)
                                presenter.getProductBySecondName(TYPE_PULL_MORE,currpage+"",cout+"",TextUtil.isEmpty(content)?"":content,type+"");
