...
public class SeachFragment extends BaseFragment implements BaseContract.View {
    ...
    public SeachFragment(Context context) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtil.isNotEmpty(tvDatefrom.getText().toString())&&TextUtil.isNotEmpty(tvDateto.getText().toString())){
                    presenter.getRankingList(currpage+"","",4+"", TimeUtil.formatTime(TimeUtil.getStringToDate(tvDatefrom.getText().toString())), TimeUtil.formatTime(TimeUtil.getStringToDate(tvDateto.getText().toString())),TYPE_PULL_REFRESH);
    ...
    public <T> void toEntity(T entity, int type) {
        ...
        if(data.data!=null&&data.data.giftList!=null){
